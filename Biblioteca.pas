...
// Foram criadas abaixo, duas funções para obter o cep junto ao WebService VIACEP
// qualquer uma das duas podem ser usadas, o objetivo é mostrar o conhecimento em diversos componentes para o mesmo objetivo

// Utilizando Client, Request e Response
function CarregarCep(cep: String): TDadosCep;
var
   json: TJSonValue;
